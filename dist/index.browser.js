(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('humps'), require('query-string'), require('ky'), require('form-data'), require('randomstring')) :
    typeof define === 'function' && define.amd ? define(['exports', 'humps', 'query-string', 'ky', 'form-data', 'randomstring'], factory) :
    (global = global || self, factory(global['node-gitlab'] = {}, global.Humps, global.QueryString, global.ky, global.FormData, global.RandomString));
}(this, function (exports, humps, queryString, ky, FormData, randomstring) { 'use strict';

    ky = ky && ky.hasOwnProperty('default') ? ky['default'] : ky;
    ...
    function defaultRequest(service, endpoint, _a) {
        ...
        return [
            urlStr,
            {
                ...
                json: typeof body === 'object' ? humps.decamelizeKeys(body, skipAllCaps) : undefined,
            },
        ];
    }
